...
const Sidebar = () => {
    const main_list = [
        {
            name: 'Home',
            path_d_value: 'M12,4.33l7,6.12V20H15V14H9v6H5V10.45l7-6.12M12,3,4,10V21h6V15h4v6h6V10L12,3Z'
        },
        {
            name: 'Shorts',
        ...
        {
            name: 'Subscriptions',
            path_d_value: 'M10,18v-6l5,3L10,18z M17,3H7v1h10V3z M20,6H4v1h16V6z M22,9H2v12h20V9z M3,10h18v10H3V10z'
        },
        {
            name: 'YouTube Music',
            path_d_value: 'M10 9.35L15 12l-5 2.65zM12 7a5 5 0 105 5 5 5 0 00-5-5m0-1a6 6 0 11-6 6 6 6 0 016-6zm0-3a9 9 0 109 9 9 9 0 00-9-9m0-1A10 10 0 112 12 10 10 0 0112 2z'
        }
    ];
    const account_list = [
        {
            name: 'Library',
            path_d_value: 'M11,7l6,3.5L11,14V7L11,7z M18,20H4V6H3v15h15V20z M21,18H6V3h15V18z M7,17h13V4H7V17z'
        },
        {
            name: 'History',
        ...
        {
            name: 'Watch Later',
            path_d_value: 'M14.97,16.95L10,13.87V7h2v5.76l4.03,2.49L14.97,16.95z M12,3c-4.96,0-9,4.04-9,9s4.04,9,9,9s9-4.04,9-9S16.96,3,12,3 M12,2c5.52,0,10,4.48,10,10s-4.48,10-10,10S2,17.52,2,12S6.48,2,12,2L12,2z'
        },
        {
            name: 'Downloads',
            path_d_value: 'M17 18V19H6V18H17ZM16.5 11.4L15.8 10.7L12 14.4V4H11V14.4L7.2 10.6L6.5 11.3L11.5 16.3L16.5 11.4Z'
        },
        {
            name: 'Liked videos',
    ...
    return (
        <div className={className}>
            <ul>
                {
                    main_list.map((item, index) => <SidebarTile info={item} key={index} />)
                }
            </ul>
            <hr className="my-3" />
            <ul>
                {
                    account_list.map((item, index) => <SidebarTile info={item} key={index} />)
                }
            </ul>
            <hr className="my-3" />
            <figure>
                <figcaption className="mx-2 px-2 my-1 py-1 font-bold">Explore</figcaption>
                <ul>
                    {
                        explore_list.map((item, index) => <SidebarTile info={item} key={index} />)
                    }
                </ul>
            </figure>
        </div>
